...
class EntuLib():
    ...
    def __init__(self, entu_user_id, entu_user_key, entu_url):
        ...
        self.expiration_time = (datetime.datetime.utcnow()+datetime.timedelta(minutes=15)).strftime('%Y-%m-%dT%H:%M:%SZ')
    ...
    def __create_policy(self, entu_query):
        ...
        policy = { 'expiration': self.expiration_time, 'conditions': conditions }
    ...
    def __post_it(self, path, method, data):
    ...
    def get_entity(self, entity_id):
        ...
        return self.__post_it(path=path, method='GET', data=None)
    ...
    def create_entity(self, parent_id, definition, properties={}):
        ...
        return self.__post_it(path=path, method='POST', data=data)
    ...
    def add_properties(self, entity_id, definition, properties):
        ...
        return self.__post_it(path=path, method='PUT', data=data)
    ...
    def add_file(self, entity_id, property_definition, abspath):
        ...
        return self.__post_it(path=path, method='POST', data=open(abspath, 'rb').read())
